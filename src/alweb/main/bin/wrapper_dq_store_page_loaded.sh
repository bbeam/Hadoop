...
################################################################################
# Name        : AngiesList                                                     #
# File        : Wrapper_DQ_Store_Page_Loaded.sh                                            #
...
hive -e "msck repair table ${ALWEB_INCOMING_DB}.${TABLE_INC_STORE_PAGE_LOADED}"
hive -e "msck repair table ${ALWEB_OPERATIONS_DB}.${TABLE_ERR_DQ_STORE_PAGE_LOADED}"
...
pig \
	...
	-file s3://al-edh-dm/src/$1/main/pig/${TABLE_DQ_STORE_PAGE_LOADED}.pig \
	-useHCatalog
