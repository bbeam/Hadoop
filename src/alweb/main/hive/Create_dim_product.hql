...
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:ALWEB_GOLD_DB}.${hivevar:TABLE_DIM_PRODUCT}
(
	source_ak INT, 
	source_table STRING, 
...
LOCATION '${hivevar:S3_LOCATION_GOLD_DATA}/${hivevar:SUBJECT_ALWEBMETRICS}/${hivevar:TABLE_DIM_PRODUCT}';