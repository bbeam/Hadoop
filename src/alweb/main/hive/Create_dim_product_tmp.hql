...
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:WORK_DB}.${hivevar:TABLE_DIM_PRODUCT_TMP}
(
	source_aK INT, 
	source_table STRING, 
...
LOCATION '${hivevar:HDFS_LOCATION}/${hivevar:SUBJECT_ALWEBMETRICS}/${hivevar:TABLE_DIM_PRODUCT_TMP}';