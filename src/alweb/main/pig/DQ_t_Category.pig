...
table_t_category = LOAD '$ALWEB_INCOMING_DB.$TABLE_T_CATEGORY' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
table_t_category_bad_error_table = FOREACH table_t_category_bad
				  GENERATE *,10001 AS error_code:INT, 'null CategoryId is not allowed' AS error_desc:CHARARRAY,$DATE AS LoadDate:CHARARRAY;
...
STORE table_t_category_good_table INTO '$WORK_DB.$TABLE_DQ_T_CATEGORY' USING org.apache.hive.hcatalog.pig.HCatStorer();