...
################################################################################
# Name        : AngiesList                                                     #
# File        : wrapper_tf_sk_fact_load.sh                                     #
...
TF_TABLE_WORK_LOCATION=$WORK_DIR/data/work/alwebmetrics/tf_nk_fact_web_metrics/
...
TF_PIG_FILE_PATH=$S3_BUCKET/src/alwebmetrics/main/pig/tf_fact_sk_load.pig
