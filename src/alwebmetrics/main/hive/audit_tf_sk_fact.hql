...
--/*
--  HIVE SCRIPT  : audit_tf_sk_fact.hql
...
SELECT      '${hivevar:ENTITY_NAME}' AS entity,
            'All Events SK Transformation' AS process,
            ...
            '${hivevar:TF_DB}.tf_sk_fact_web_metrics' AS table_name
 FROM ${hivevar:TF_DB}.tf_sk_fact_web_metrics;