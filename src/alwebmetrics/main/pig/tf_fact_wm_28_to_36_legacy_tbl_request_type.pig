/*#########################################################################################################
PIG SCRIPT                              :tf_fact_wm_28_to_36_legacy_tbl_request_type.pig
...
dq_tbl_request_type_info_fltr = FILTER dq_tbl_request_type_info BY request_type_id IN (28, 29, 30, 31, 32, 33, 34, 35, 36);
...
tf_legacy_tbl_request_type = FOREACH un_requests_members_sp 
    GENERATE    id AS id,
                ...
                (request_type_id == 30 ? 'Category Request' :(request_type_id == 36 ? 'Service Provider Request':(request_type_id == 32 ? 'Keyword Request':(request_type_id == 34 ? 'MyAngie Request':(request_type_id == 31 ? 'Coupon Request':(request_type_id == 33 ? 'KeywordBought Request':(request_type_id == 29 ? 'Blended Request':(request_type_id == 35 ? 'Quick Quote Request':(request_type_id == 28 ? 'BigDeal Feedback Interstitial Page':'$STRING_MISSING_VALUE'))))))))) as event_type,
