...
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:DB_NAME}.inc_member_address
(
	member_id STRING,
...
LOCATION '${hivevar:S3_BUCKET}/data/incoming/legacy/angie/dbo/full/daily/inc_member_address';
