--/*
--  HIVE SCRIPT  : create_angie_dbo_inc_member_logon_history.hql
--  AUTHOR       : Ashoka Reddy
--  DATE         : Jun 23, 2016
...
LOCATION '${hivevar:S3_BUCKET}/data/incoming/legacy/angie/dbo/incremental/daily/inc_member_logon_history';