--  HIVE SCRIPT  : create_dq_greenpoint_android_prod_screens.hql
...
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:SEGMENT_GOLD_DB}.dq_greenpoint_android_prod_screens
(
id VARCHAR(254),
...
LOCATION '${hivevar:S3_BUCKET}/data/gold/${hivevar:SOURCE_SEGMENT}/greenpoint_android_prod/incremental/daily/dq_greenpoint_android_prod_screens';
