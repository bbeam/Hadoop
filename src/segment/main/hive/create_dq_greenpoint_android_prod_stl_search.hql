...
--  DATE         : Jul 13, 2016
--  DESCRIPTION  : Creation of hive dq table(Dq_stl_search). 

--*/

--  Creating a DQ hive table(Dq_purchased_cart) over the incoming data
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:DB_NAME}.dq_stl_search
( 
id  VARCHAR(254) ,
...
LOCATION '${hivevar:S3_BUCKET}/data/gold/segment/events/greenpoint_android_prod/incremental/daily/dq_stl_search';
