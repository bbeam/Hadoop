--  HIVE SCRIPT  : create_dq_screens.hql
--  AUTHOR       : Abhinav Mehar
--  DATE         : Jul 13, 2016
--  DESCRIPTION  : Creation of hive dq table(Dq_Store_Page_Loaded). 
--  USAGE    : hive -f s3://al-edh-dev/src/segment/main/hive/create_dq_screens.hql \
...
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:SEGMENT_GOLD_DB}.dq_screens
(
id VARCHAR(254),
...
LOCATION '${hivevar:S3_BUCKET}/data/gold/${hivevar:SOURCE_SEGMENT}/greenpoint_android_prod/incremental/daily/dq_screens';
