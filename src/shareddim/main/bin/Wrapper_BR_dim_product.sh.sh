...
aws s3 cp s3://al-edh-dm/src/common/main/conf/common.properties /var/tmp/
...
#Hive Script to load audit information into EDH_Batch_Audit table 
hive -f s3://al-edh-dm/src/common/main/hive/Audit_${TABLE_BR_DIM_CATEGORY}.hql \
