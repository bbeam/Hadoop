...
hive -f $LOAD_DEFAULT_DIM_VALUES_HQL \
    ...
    -hivevar NUMERIC_MISSING_VALUE=$NUMERIC_MISSING_VALUE \
    -hivevar NUMERIC_NA_VALUE=$NUMERIC_NA_VALUE \
    -hivevar STRING_UNKOWN_VALUE=$STRING_UNKOWN_VALUE \
    -hivevar NUMERIC_UNKOWN_VALUE=$NUMERIC_UNKOWN_VALUE
