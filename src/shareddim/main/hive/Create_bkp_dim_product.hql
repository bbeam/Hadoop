...
CREATE EXTERNAL TABLE IF NOT EXISTS ${hivevar:ALWEBMETRICS_OPERATIONS}.${hivevar:TABLE_BKP_DIM_PRODUCT}
(source_aK INT,
source_table STRING,
...
)PARTITIONED BY (LoadMonth STRING)
STORED AS ORC
LOCATION '${hivevar:S3_LOCATION_OPERATIONS_DATA}/${hivevar:SUBJECT_ALWEBMETRICS}/${hivevar:TABLE_BKP_DIM_PRODUCT}';