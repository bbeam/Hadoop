...
--  AUTHOR       : Ashoka Reddy
--  DATE         : Jul 02, 2016
--  DESCRIPTION  : Creation of backup table(bkp_dim_product) of  target table (dim_product) table. 
--*/


--  Creating a back up hive table(bkp_dim_product) of target (dim_product) table 
